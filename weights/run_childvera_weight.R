# ==========================================================
# Child version a interview weight
# ==========================================================

run_childvera_weight <- function(years) {
  
  # Specify inputs ---------------------
  
  pop_total <- config$child_pop
  input <- config$input_files$verachild
  wt_name <- 'cva'
  name <- 'Child version a'
  totals_input <- config$totals_files$child_all

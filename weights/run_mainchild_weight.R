# ==========================================================
# Main child interview weight
# ==========================================================

run_mainchild_weight <- function(years) {
  
  # Specify inputs ---------------------
  
  pop_total <- config$child_pop
  input <- config$input_files$mainchild
  wt_name <- 'cmint'
  name <- 'Main child'
  totals_input <- config$totals_files$child_main

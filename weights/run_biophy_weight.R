# ==========================================================
# Bio adult (physical measurement) interview weight
# ==========================================================

run_biophy_weight <- function(years) {
  
  # Specify inputs ---------------------
  
  pop_total <- config$adult_pop
  input <- config$input_files$biophy
  wt_name <- 'biophy'
  name <- 'Bio adult (physical measurements)'
  totals_input <- config$totals_files$biomod_adult
